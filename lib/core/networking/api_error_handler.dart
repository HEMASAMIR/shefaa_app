...
import 'package:shefaa_app_flutter/core/networking/api_error_model.dart';
...
class ApiErrorHandler {
  ...
  static ApiErrorModel _handleError(int? statusCode, dynamic error) {
    ...
    if (error is Map<String, dynamic>) {
      ...
      return ApiErrorModel(message: message, code: statusCode, errors: error);
    } else if (error is String) {
      // If error is a String, use it directly as message
      return ApiErrorModel(message: error, code: statusCode);
    } else {
